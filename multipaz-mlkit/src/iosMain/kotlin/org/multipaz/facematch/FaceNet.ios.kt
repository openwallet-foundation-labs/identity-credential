...
private object FaceNetInterpreter {
    ...
    fun initialize() {
        ...
        val modelFilePath = LRTModelLoader.extractModelResourceToPlatformFile()
...
actual fun getFaceEmbeddings(image: ImageBitmap, imgSize: Int, embeddingDim: Int): FloatArray? {
    ...
    val inputImageData: FloatArray = preprocessImage(image, imgSize)
