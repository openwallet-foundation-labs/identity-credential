...
import com.ul.ims.gmdl.viewmodel.QrcodeScanViewModel
...
class QrcodeScanFragment : Fragment() {
    ...
    private fun startScanner() {
        ...
        val requestItems = MdlNamespace.items.keys.filter {
            it != MdlDataIdentifiers.
            PORTRAIT_OF_HOLDER.identifier }.toList()
    ...
    private fun showPermissionDenied() {
        ...
        val permissionDeniedText = view?.findViewById<TextView>(R.id.txt_explanation_camera_permission)
