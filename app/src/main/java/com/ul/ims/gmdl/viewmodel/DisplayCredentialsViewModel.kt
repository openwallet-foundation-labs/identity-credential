...
class DisplayCredentialsViewModel(val app: Application) : AndroidViewModel(app) {
    ...
    var credentialVisibitity = ObservableField<Int>()
    ...
    fun verifyIssuerDataAuthenticity(issuerAuth : CoseSign1?,
    ...
    private fun verifyIssuerDataVerifierAsync(coseSign1 : CoseSign1,
                                              issuerNameSpaces : IssuerNameSpaces) : Single<Boolean> {
        return Single.create {emitter ->
            doAsync {
                ...
                mso?.let {
                    val rootCertificateInitialiser = RootCertificateInitialiser(app.applicationContext)
    ...
    private inner class ProvisionConsumer(val showShareButton : Boolean) :
        ...
        override fun onSuccess(t: UserCredential) {
            ...
            credentialVisibitity.set(View.VISIBLE)
        ...
        override fun onSubscribe(d: Disposable) {
            ...
            credentialVisibitity.set(View.GONE)
