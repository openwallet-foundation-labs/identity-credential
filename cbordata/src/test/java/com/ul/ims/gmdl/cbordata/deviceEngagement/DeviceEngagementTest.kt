...
class DeviceEngagementTest {
    ...
    val encodedExpected = byteArrayOf(
        ...
        0x01.toByte(), 0x21.toByte(), 0x58.toByte(), 0x20.toByte(), 0x1a.toByte(),
        0xd2.toByte(), 0x71.toByte(), 0xbe.toByte(), 0x8d.toByte(), 0x9f.toByte(),
        0x0b.toByte(), 0x1f.toByte(), 0x99.toByte(), 0x20.toByte(), 0x37.toByte(),
        0x2a.toByte(), 0x66.toByte(), 0x20.toByte(), 0x95.toByte(), 0x89.toByte(),
        0x05.toByte(), 0xd3.toByte(), 0xcd.toByte(), 0x95.toByte(), 0x82.toByte(),
        0xc2.toByte(), 0x40.toByte(), 0x94.toByte(), 0x3b.toByte(), 0x90.toByte(),
        0xa0.toByte(), 0xf7.toByte(), 0x5f.toByte(), 0xc5.toByte(), 0xe1.toByte(),
        0x07.toByte(), 0x22.toByte(), 0x58.toByte(), 0x20.toByte(), 0xb7.toByte(),
        0xe3.toByte(), 0x7b.toByte(), 0xb4.toByte(), 0x09.toByte(), 0x82.toByte(),
        0x8a.toByte(), 0x8e.toByte(), 0x3e.toByte(), 0x8a.toByte(), 0x48.toByte(),
        0x99.toByte(), 0x36.toByte(), 0x0a.toByte(), 0x7b.toByte(), 0xfd.toByte(),
        0xd3.toByte(), 0xa9.toByte(), 0xaa.toByte(), 0x48.toByte(), 0x5b.toByte(),
        0xe5.toByte(), 0x0d.toByte(), 0xf0.toByte(), 0x39.toByte(), 0x4a.toByte(),
        0x49.toByte(), 0x47.toByte(), 0x38.toByte(), 0x3e.toByte(), 0xb0.toByte(),
        0xe2.toByte(), 0x81.toByte(), 0x83.toByte(), 0x02.toByte(), 0x01.toByte(),
        0xa2.toByte(), 0x00.toByte(), 0xf4.toByte(), 0x01.toByte(), 0xf5.toByte(),
        0xa3.toByte(), 0x64.toByte(), 0x4f.toByte(), 0x49.toByte(), 0x44.toByte(),
        0x43.toByte(), 0x83.toByte(), 0x02.toByte(), 0x68.toByte(), 0x6f.toByte(),
        0x69.toByte(), 0x64.toByte(), 0x63.toByte(), 0x2d.toByte(), 0x75.toByte(),
        0x72.toByte(), 0x6c.toByte(), 0x6a.toByte(), 0x6f.toByte(), 0x69.toByte(),
        0x64.toByte(), 0x63.toByte(), 0x2d.toByte(), 0x74.toByte(), 0x6f.toByte(),
        0x6b.toByte(), 0x65.toByte(), 0x6e.toByte(), 0x66.toByte(), 0x57.toByte(),
        0x65.toByte(), 0x62.toByte(), 0x41.toByte(), 0x50.toByte(), 0x49.toByte(),
        0x83.toByte(), 0x01.toByte(), 0x78.toByte(), 0x22.toByte(), 0x74.toByte(),
        0x72.toByte(), 0x69.toByte(), 0x64.toByte(), 0x65.toByte(), 0x6e.toByte(),
        0x74.toByte(), 0x2e.toByte(), 0x71.toByte(), 0x75.toByte(), 0x61.toByte(),
        0x72.toByte(), 0x69.toByte(), 0x6e.toByte(), 0x2e.toByte(), 0x6e.toByte(),
        0x65.toByte(), 0x74.toByte(), 0x2f.toByte(), 0x4d.toByte(), 0x56.toByte(),
        0x52.toByte(), 0x2d.toByte(), 0x42.toByte(), 0x61.toByte(), 0x63.toByte(),
        0x6b.toByte(), 0x65.toByte(), 0x6e.toByte(), 0x64.toByte(), 0x2e.toByte(),
        0x41.toByte(), 0x70.toByte(), 0x69.toByte(), 0x68.toByte(), 0x61.toByte(),
        0x62.toByte(), 0x63.toByte(), 0x64.toByte(), 0x61.toByte(), 0x62.toByte(),
        0x63.toByte(), 0x64.toByte(), 0x67.toByte(), 0x63.toByte(), 0x6f.toByte(),
        0x6d.toByte(), 0x70.toByte(), 0x61.toByte(), 0x63.toByte(), 0x74.toByte(),
        0xf4.toByte(), 0x80.toByte(), 0xa3.toByte(), 0x66.toByte(), 0x70.toByte(),
        0x72.toByte(), 0x6f.toByte(), 0x70.toByte(), 0x5f.toByte(), 0x31.toByte(),
        0x67.toByte(), 0x76.toByte(), 0x61.toByte(), 0x6c.toByte(), 0x75.toByte(),
        0x65.toByte(), 0x5f.toByte(), 0x35.toByte(), 0x66.toByte(), 0x70.toByte(),
        0x72.toByte(), 0x6f.toByte(), 0x70.toByte(), 0x5f.toByte(), 0x32.toByte(),
        0x67.toByte(), 0x76.toByte(), 0x61.toByte(), 0x6c.toByte(), 0x75.toByte(),
        0x65.toByte(), 0x5f.toByte(), 0x33.toByte(), 0x66.toByte(), 0x70.toByte(),
        0x72.toByte(), 0x6f.toByte(), 0x70.toByte(), 0x5f.toByte(), 0x33.toByte(),
        0x67.toByte(), 0x76.toByte(), 0x61.toByte(), 0x6c.toByte(), 0x75.toByte(),
        0x65.toByte(), 0x5f.toByte(), 0x31.toByte()
    )
    ...
    fun testBuilder() {
        ...
        Assert.assertEquals(1, deviceEngagement.transferMethods?.size)
    ...
    fun testDecode() {
        ...
        Assert.assertEquals(1, decoded.transferMethods?.size)
