...
class RequestTest {
    ...
    private val expectedEncodedRequest = byteArrayOf(
        ...
        0x65.toByte(), 0x6d.toByte(), 0x73.toByte(), 0x52.toByte(), 0x65.toByte(),
        0x71.toByte(), 0x75.toByte(), 0x65.toByte(), 0x73.toByte(), 0x74.toByte(),
        0xd8.toByte(), 0x18.toByte(), 0x58.toByte(), 0xe9.toByte(), 0xa2.toByte(),
        0x67.toByte(), 0x64.toByte(), 0x6f.toByte(), 0x63.toByte(), 0x54.toByte(),
        0x79.toByte(), 0x70.toByte(), 0x65.toByte(), 0x75.toByte(), 0x6f.toByte(),
        0x72.toByte(), 0x67.toByte(), 0x2e.toByte(), 0x69.toByte(), 0x73.toByte(),
        0x6f.toByte(), 0x2e.toByte(), 0x31.toByte(), 0x38.toByte(), 0x30.toByte(),
        ...
        0x2e.toByte(), 0x31.toByte(), 0x38.toByte(), 0x30.toByte(), 0x31.toByte(),
        0x33.toByte(), 0x2e.toByte(), 0x35.toByte(), 0x2e.toByte(), 0x31.toByte(),
        0xac.toByte(), 0x68.toByte(), 0x70.toByte(), 0x6f.toByte(), 0x72.toByte(),
        0x74.toByte(), 0x72.toByte(), 0x61.toByte(), 0x69.toByte(), 0x74.toByte(),
        0xf4.toByte(), 0x6a.toByte(), 0x62.toByte(), 0x69.toByte(), 0x72.toByte(),
        0x74.toByte(), 0x68.toByte(), 0x5f.toByte(), 0x64.toByte(), 0x61.toByte(),
        0x74.toByte(), 0x65.toByte(), 0xf4.toByte(), 0x6a.toByte(), 0x67.toByte(),
        ...
        0x6a.toByte(), 0x69.toByte(), 0x73.toByte(), 0x73.toByte(), 0x75.toByte(),
        0x65.toByte(), 0x5f.toByte(), 0x64.toByte(), 0x61.toByte(), 0x74.toByte(),
        0x65.toByte(), 0xf4.toByte(), 0x6b.toByte(), 0x61.toByte(), 0x67.toByte(),
        0x65.toByte(), 0x5f.toByte(), 0x6f.toByte(), 0x76.toByte(), 0x65.toByte(),
        0x72.toByte(), 0x5f.toByte(), 0x31.toByte(), 0x38.toByte(), 0xf4.toByte(),
        0x6b.toByte(), 0x61.toByte(), 0x67.toByte(), 0x65.toByte(), 0x5f.toByte(),
        0x6f.toByte(), 0x76.toByte(), 0x65.toByte(), 0x72.toByte(), 0x5f.toByte(),
        0x32.toByte(), 0x31.toByte(), 0xf4.toByte(), 0x6b.toByte(), 0x65.toByte(),
        0x78.toByte(), 0x70.toByte(), 0x69.toByte(), 0x72.toByte(), 0x79.toByte(),
        0x5f.toByte(), 0x64.toByte(), 0x61.toByte(), 0x74.toByte(), 0x65.toByte(),
        0xf4.toByte(), 0x6b.toByte(), 0x66.toByte(), 0x61.toByte(), 0x6d.toByte(),
        0x69.toByte(), 0x6c.toByte(), 0x79.toByte(), 0x5f.toByte(), 0x6e.toByte(),
        0x61.toByte(), 0x6d.toByte(), 0x65.toByte(), 0xf4.toByte(), 0x6f.toByte(),
        ...
        0xf4.toByte(), 0x6f.toByte(), 0x69.toByte(), 0x73.toByte(), 0x73.toByte(),
        0x75.toByte(), 0x69.toByte(), 0x6e.toByte(), 0x67.toByte(), 0x5f.toByte(),
        0x63.toByte(), 0x6f.toByte(), 0x75.toByte(), 0x6e.toByte(), 0x74.toByte(),
        0x72.toByte(), 0x79.toByte(), 0xf4.toByte(), 0x71.toByte(), 0x69.toByte(),
        0x73.toByte(), 0x73.toByte(), 0x75.toByte(), 0x69.toByte(), 0x6e.toByte(),
        0x67.toByte(), 0x5f.toByte(), 0x61.toByte(), 0x75.toByte(), 0x74.toByte(),
        0x68.toByte(), 0x6f.toByte(), 0x72.toByte(), 0x69.toByte(), 0x74.toByte(),
        0x79.toByte(), 0xf4.toByte(), 0x72.toByte(), 0x64.toByte(), 0x72.toByte(),
