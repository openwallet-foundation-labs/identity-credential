...
enum class Algorithm(
    ...
    /** ECDH w/ Curve P-256 without KDF */
    ECDH_P256(fullySpecified = true,
        description = "ECDH w/ Curve P-256 without KDF", curve = EcCurve.P256,
        isKeyAgreement = true),

    /** ECDH w/ Curve P-384 without KDF */
    ECDH_P384(fullySpecified = true,
        description = "ECDH w/ Curve P-384 without KDF", curve = EcCurve.P384,
        isKeyAgreement = true),

    /** ECDH w/ Curve P-521 without KDF */
    ECDH_P521(fullySpecified = true,
        description = "ECDH w/ Curve P-521 without KDF", curve = EcCurve.P521,
        isKeyAgreement = true),

    /** ECDH w/ Curve BrainpoolP256r1 without KDF */
    ECDH_BRAINPOOLP256R1(fullySpecified = true,
        description = "ECDH w/ Curve BrainpoolP256r1 without KDF", curve = EcCurve.BRAINPOOLP256R1,
        isKeyAgreement = true),

    /** ECDH w/ Curve BrainpoolP320r1 without KDF */
    ECDH_BRAINPOOLP320R1(fullySpecified = true,
        description = "ECDH w/ Curve BrainpoolP320r1 without KDF", curve = EcCurve.BRAINPOOLP320R1,
        isKeyAgreement = true),

    /** ECDH w/ Curve BrainpoolP384r1 without KDF */
    ECDH_BRAINPOOLP384R1(fullySpecified = true,
        description = "ECDH w/ Curve BrainpoolP384r1 without KDF", curve = EcCurve.BRAINPOOLP384R1,
        isKeyAgreement = true),

    /** ECDH w/ Curve BrainpoolP512r1 without KDF */
    ECDH_BRAINPOOLP512R1(fullySpecified = true,
        description = "ECDH w/ Curve BrainpoolP512r1 without KDF", curve = EcCurve.BRAINPOOLP512R1,
        isKeyAgreement = true),

    /** ECDH w/ Curve X25519 without KDF */
    ECDH_X25519(fullySpecified = true,
        description = "ECDH w/ Curve X25519 without KDF", curve = EcCurve.X25519,
        isKeyAgreement = true),

    /** ECDH w/ Curve X448 without KDF */
    ECDH_X448(fullySpecified = true,
        description = "ECDH w/ Curve X448 without KDF", curve = EcCurve.X448,
        isKeyAgreement = true),
