...
public class DeviceResponseParserTest {
    ...
    @Test
    @SmallTest
    public void testDeviceResponseParserWithVectors() {
        ...
        //
        Collection<X509Certificate> issuerCertChain = d.getIssuerCertificateChain();
        Assert.assertEquals(1, issuerCertChain.size());
        X509Certificate issuerCert = issuerCertChain.iterator().next();
