...
class SqliteStorage(
    ...
    /** Detects bundled and native SQLiteDrivers, which do support RETURNING clause. */
    internal val isBundledOrNative: Boolean get() {
        val className = connection::class.simpleName!!
        return className.startsWith("Bundled") || className.startsWith("Native")
    }
}