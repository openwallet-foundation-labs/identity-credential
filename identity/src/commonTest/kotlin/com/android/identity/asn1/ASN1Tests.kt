...
class ASN1Tests {
    ...
    @Test
    fun testEnumerated() {
        assertEquals("0a0100", ASN1.encode(ASN1Integer(0, ASN1IntegerTag.ENUMERATED.tagNumber)).toHex())
        assertEquals("0a0101", ASN1.encode(ASN1Integer(1, ASN1IntegerTag.ENUMERATED.tagNumber)).toHex())
        assertEquals("0a020080", ASN1.encode(ASN1Integer(128L, ASN1IntegerTag.ENUMERATED.tagNumber)).toHex())
        assertEquals("0a01ff", ASN1.encode(ASN1Integer(-1L, ASN1IntegerTag.ENUMERATED.tagNumber)).toHex())
        assertEquals("0a02ff01", ASN1.encode(ASN1Integer(-255L, ASN1IntegerTag.ENUMERATED.tagNumber)).toHex())
        assertEquals("0a02ff00", ASN1.encode(ASN1Integer(-256L, ASN1IntegerTag.ENUMERATED.tagNumber)).toHex())

        assertEquals(ASN1Integer(0L, ASN1IntegerTag.ENUMERATED.tagNumber), ASN1.decode("0a0100".fromHex()))
        assertEquals(ASN1Integer(1L, ASN1IntegerTag.ENUMERATED.tagNumber), ASN1.decode("0a0101".fromHex()))
        assertEquals(ASN1Integer(128L, ASN1IntegerTag.ENUMERATED.tagNumber), ASN1.decode("0a020080".fromHex()))
        assertEquals(ASN1Integer(-1L, ASN1IntegerTag.ENUMERATED.tagNumber), ASN1.decode("0a01ff".fromHex()))
        assertEquals(ASN1Integer(-255L, ASN1IntegerTag.ENUMERATED.tagNumber), ASN1.decode("0a02ff01".fromHex()))
        assertEquals(ASN1Integer(-256L, ASN1IntegerTag.ENUMERATED.tagNumber), ASN1.decode("0a02ff00".fromHex()))
        ...
        assertEquals(
            ...
            """.trimIndent(),
            ASN1.print(ASN1Sequence(listOf(
                ASN1Integer(0L, ASN1IntegerTag.ENUMERATED.tagNumber),
                ASN1Integer(1L, ASN1IntegerTag.ENUMERATED.tagNumber),
                ASN1Integer(128L, ASN1IntegerTag.ENUMERATED.tagNumber),
                ASN1Integer(-1L, ASN1IntegerTag.ENUMERATED.tagNumber),
                ASN1Integer(-255L, ASN1IntegerTag.ENUMERATED.tagNumber),
                ASN1Integer(-256L, ASN1IntegerTag.ENUMERATED.tagNumber),
            ))).trim()
        )
    }
    ...
    fun testTime() {
        val pairs = mapOf<ASN1Object, ByteArray>(
            ASN1Time(
                ...
                ASN1TimeTag.UTC_TIME.tagNumber
            ...
            ASN1Time(
                ...
                ASN1TimeTag.GENERALIZED_TIME.tagNumber
    ...
    fun testStrings() {
        ...
        assertEquals(
            ...
            ASN1.print(ASN1Sequence(
                ASN1StringTag.entries.map { ASN1String("String with tag value ${it.tagNumber}", it.tagNumber) }
            )).trim()
        )
    }
