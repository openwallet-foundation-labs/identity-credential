...
public class IdentityCredentialStoreCapabilities {
    ...
    /**
     * The feature version corresponding to features included in the Identity Credential API
     * shipped in Android 13. This feature version adds support for
    ...
    /**
     * Returns true if
     * {@link IdentityCredentialStore#createPresentationSession(int)} is supported by the
     * underlying hardware.
     *
     * <p>This is supported in feature version {@link #FEATURE_VERSION_202201} and later.
     *
     * <p>This is always supported by the software-based store.
     *
     * @return {@code true} if supported, {@code false} if not.
    ...
    /**
     * Returns true if
     * {@link IdentityCredential#setIncrementKeyUsageCount(boolean)} is supported by the
     * underlying hardware.
     *
     * <p>This is supported in feature version {@link #FEATURE_VERSION_202201} and later.
     *
