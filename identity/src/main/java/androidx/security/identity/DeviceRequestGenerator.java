...
public class DeviceRequestGenerator {
     ...
     */
    public @NonNull DeviceRequestGenerator setSessionTranscript(
     ...
     * @param itemsToRequest the items to request as a map of namespaces into data element
    ...
    public @NonNull byte[] generate() {
        byte[] deviceRequest = Util.cborEncode(new CborBuilder()
                .addMap()
                .put("version", "1.0")
