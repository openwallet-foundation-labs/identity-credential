 ...
 * @hide
 *
 * Utility functions used in androidx.security.identity.lowlevel code.
 */
...
public class Util {
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] fromHex(@NonNull String stringWithHex) {
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] cborEncode(@NonNull DataItem dataItem) {
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] cborEncodeBoolean(boolean value) {
        return cborEncode(new CborBuilder().add(value).build().get(0));
    }

    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] cborEncodeString(@NonNull String value) {
        return cborEncode(new CborBuilder().add(value).build().get(0));
    }

    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] cborEncodeNumber(long value) {
        return cborEncode(new CborBuilder().add(value).build().get(0));
    }

    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] cborEncodeBytestring(@NonNull byte[] value) {
        return cborEncode(new CborBuilder().add(value).build().get(0));
    }

    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] cborEncodeDateTime(@NonNull Calendar calendar) {
        return cborEncode(cborBuildDateTime(calendar));
    }

    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] cborEncodeDateTimeFor18013_5(@NonNull Calendar calendar) {
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull DataItem cborBuildDateTime(@NonNull Calendar calendar) {
     ...
     * as specificed in ISO/IEC 18013-5:
     *
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull DataItem cborBuildDateTimeFor18013_5(@NonNull Calendar calendar) {
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssXXX");
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull DataItem cborDecode(@NonNull byte[] encodedBytes) {
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull String cborDecodeString(@NonNull byte[] data) {
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] cborDecodeByteString(@NonNull byte[] data) {
        DataItem dataItem = cborDecode(data);
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull Calendar cborDecodeDateTime(@NonNull byte[] data) {
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] computeHkdf(
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull DataItem coseMac0(@NonNull SecretKey key,
            @Nullable byte[] data,
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] coseMac0GetTag(@NonNull DataItem coseMac0) {
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] stripLeadingZeroes(@NonNull byte[] value) {
        int n = 0;
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull DataItem cborExtractTaggedAndEncodedCbor(@NonNull DataItem item) {
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] coseSign1GetData(@NonNull DataItem coseSign1) {
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull String cborMapExtractString(@NonNull DataItem map,
            @NonNull String key) {
        if (!(map instanceof Map)) {
            throw new IllegalArgumentException("Expected map");
        }
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull List<DataItem> cborMapExtractArray(@NonNull DataItem map,
            @NonNull String key) {
        if (!(map instanceof Map)) {
            throw new IllegalArgumentException("Expected map");
        }
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull List<DataItem> cborMapExtractArray(@NonNull DataItem map, int key) {
        if (!(map instanceof Map)) {
            throw new IllegalArgumentException("Expected map");
        }
        DataItem keyDataItem = key >= 0 ? new UnsignedInteger(key) : new NegativeInteger(key);
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull DataItem cborMapExtractMap(@NonNull DataItem map,
            @NonNull String key) {
        if (!(map instanceof Map)) {
            throw new IllegalArgumentException("Expected map");
        }
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull Collection<String> cborMapExtractMapStringKeys(@NonNull DataItem map) {
        if (!(map instanceof Map)) {
            throw new IllegalArgumentException("Expected map");
        }
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull Collection<Integer> cborMapExtractMapNumberKeys(@NonNull DataItem map) {
        if (!(map instanceof Map)) {
            throw new IllegalArgumentException("Expected map");
        }
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] cborMapExtractByteString(@NonNull DataItem map,
            int key) {
        if (!(map instanceof Map)) {
            throw new IllegalArgumentException("Expected map");
        }
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull DataItem cborMapExtract(@NonNull DataItem map, @NonNull String key) {
        if (!(map instanceof Map)) {
            throw new IllegalArgumentException("Expected map");
        }
        DataItem item = ((Map) map).get(new UnicodeString(key));
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull PublicKey coseKeyDecode(@NonNull DataItem coseKey) {
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull SecretKey calcEMacKeyForReader(
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull String cborPrettyPrint(@NonNull DataItem dataItem) {
        StringBuilder sb = new StringBuilder();
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull String cborPrettyPrint(@NonNull byte[] encodedBytes) {
        StringBuilder sb = new StringBuilder();
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull byte[] canonicalizeCbor(@NonNull byte[] encodedCbor) {
        return cborEncode(cborDecode(encodedCbor));
    }

    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull String replaceLine(@NonNull String text, int lineNumber,
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY) public static @NonNull byte[] createItemsRequest(
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @Nullable byte[] getPopSha256FromAuthKeyCert(@NonNull X509Certificate cert) {
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull DataItem calcIssuerSignedItemBytes(int digestID,
            @NonNull byte[] random,
     ...
     */
    public static @NonNull byte[] issuerSignedItemBytesClearValue(
     ...
     */
    public static @NonNull  byte[] issuerSignedItemBytesSetValue(
            @NonNull byte[] encodedIssuerSignedItemBytes,
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull PrivateKey getPrivateKeyFromInteger(@NonNull BigInteger s) {
        try {
            AlgorithmParameters params = AlgorithmParameters.getInstance("EC");
            params.init(new ECGenParameterSpec("prime256v1"));
            ECParameterSpec ecParameters = params.getParameterSpec(ECParameterSpec.class);
    ...
    /** @hide */
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public static @NonNull PublicKey getPublicKeyFromIntegers(@NonNull BigInteger x,
    ...
    //
    static public @Nullable ByteBuffer readBytes(@NonNull InputStream inputStream, int numBytes)
    throws IOException {
        ...
        while (numBytesRemaining > 0) {
            int numRead = 0;
            numRead = inputStream.read(data.array(), offset, numBytesRemaining);
            if (numRead == -1) {
                return null;
            }
            if (numRead == 0) {
