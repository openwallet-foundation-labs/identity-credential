...
public class DeviceResponseGenerator {
     ...
     *
     * <p></p>Issuer-signed data is provided in <code>issuerSignedData</code> which
     ...
     * user. Of the latter two, exactly one of them must be non-<code>null</code>.
    ...
    public @NonNull DeviceResponseGenerator addDocument(@NonNull String docType,
        ...
        DataItem issuerSignedDataItem = new CborBuilder()
                .addMap()
        ...
        DataItem deviceSignedDataItem = new CborBuilder()
                .addMap()
        ...
        mDocumentsBuilder.add(new CborBuilder()
                .addMap()
                .put("docType", docType)
                .put(new UnicodeString("issuerSigned"), issuerSignedDataItem)
                .put(new UnicodeString("deviceSigned"), deviceSignedDataItem)
                .end()
                .build().get(0));
        return this;
    }
