...
class SoftwareIdentityCredential extends IdentityCredential {
    ...
    private boolean mSessionTranscriptChecksDisabled = false;
    private boolean mIncrementKeyUsageCount = true;

    // TODO: remove
    void setSessionTranscriptChecksDisabled(boolean value) {
        mSessionTranscriptChecksDisabled = value;
    }
    ...
    public ResultData getEntries(
        ...
        if (!mSessionTranscriptChecksDisabled && mPresentationSession == null) {
    ...
    private int checkAccessSingleProfile(AccessControlProfile profile,
        ...
        boolean perPresentationAuthObtained = didUserAuth();
