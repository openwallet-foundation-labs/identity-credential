...
class SimpleIdentityCredentialStoreCapabilities extends IdentityCredentialStoreCapabilities {
    ...
    boolean mIsCreatePresentationSessionSupported;
    boolean mIsSetIncrementKeyUsageCountSupported;
    ...
    SimpleIdentityCredentialStoreCapabilities(boolean isDirectAccess,
            ...
            boolean isCreatePresentationSessionSupported,
            boolean isSetIncrementKeyUsageCountSupported)
            {
        ...
        mIsCreatePresentationSessionSupported = isCreatePresentationSessionSupported;
        mIsSetIncrementKeyUsageCountSupported = isSetIncrementKeyUsageCountSupported;
    }
    ...
    static SimpleIdentityCredentialStoreCapabilities getFeatureVersion202201(
            boolean isDirectAccess,
            boolean isHardwareBacked,
            Set<String> supportedDocTypesSet) {
        return new SimpleIdentityCredentialStoreCapabilities(
                isDirectAccess,
                IdentityCredentialStoreCapabilities.FEATURE_VERSION_202201,
                isHardwareBacked,
                supportedDocTypesSet,
                true,
                true,
    ...
    @Override
    public boolean isCreatePresentationSessionSupported() {
        return mIsCreatePresentationSessionSupported;
    }

    @Override
    public boolean isSetIncrementKeyUsageCountSupported() {
        return mIsSetIncrementKeyUsageCountSupported;
    }
