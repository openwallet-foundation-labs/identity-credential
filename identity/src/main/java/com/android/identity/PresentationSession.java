 ...
 * {@link IdentityCredential#getEntries(byte[], Map, byte[])} method.
 *
...
public abstract class PresentationSession {
     ...
     * the returned {@link CredentialDataResult}. If
     * {@link CredentialDataResult.Entries#STATUS_USER_AUTHENTICATION_FAILED} is returned the
     * application should call {@link #getCryptoObject()} and use the returned
     ...
     * may call {@link #getCredentialData(String, CredentialDataRequest)} again.
     *
