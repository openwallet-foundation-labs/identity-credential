 ...
 *
 * <p>This is used in {@link PresentationSession#getCredentialData(String, CredentialDataRequest)}.
 */
final public class CredentialDataRequest {
     ...
     * <p>By default this is set to true.
     *
     * @return whether to increment the user count of the authentication key used.
     */
