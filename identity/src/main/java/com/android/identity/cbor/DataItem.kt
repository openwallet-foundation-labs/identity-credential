...
sealed class DataItem(
     ...
     *
     * This is equivalent to calling [Certificate.fromDataItem].
     *
     * @throws IllegalArgumentException if not the data item isn't a certificate.
     */
    val asCertificate: Certificate
        get() = Certificate.fromDataItem(this)

    /**
     * The value of a data item containing a certificate chain.
     *
     * This is equivalent to calling [CertificateChain.fromDataItem].
     *
     * @throws IllegalArgumentException if not the data item isn't a certificate chain.
     */
    val asCertificateChain: CertificateChain
        get() = CertificateChain.fromDataItem(this)
}
