...
class TrustManager {
    ...
    fun verify(
        chain: List<X509Cert>,
        // TODO: customValidators: List<PKIXCertPathChecker> = emptyList()
    ): TrustResult {
        try {
    ...
    private fun validateCertificationTrustPath(
        ...
        // TODO: TrustManagerUtil.executeCustomValidations(leafCertificate, customValidators)
        ...
        while (certIterator.hasNext()) {
            ...
            // TODO: TrustManagerUtil.executeCustomValidations(caCertificate, customValidators)
