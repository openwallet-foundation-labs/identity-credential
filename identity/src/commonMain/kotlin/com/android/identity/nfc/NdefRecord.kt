...
data class NdefRecord(
     ...
     * @param mb set to `true` if this is the first record of a message.
     * @param me set to `true` if this is the last record of a message.
     */
    internal fun encode(
        buf: Buffer,
        mb: Boolean,
        ...
        val il = if (tnf == Tnf.EMPTY) true else (id.size > 0)
        var flags = tnf.value
