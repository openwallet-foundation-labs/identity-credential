...
abstract class NfcIsoTag {
     ...
     */
    suspend fun selectApplication(applicationId: ByteArray) {
        ...
        val response = transceive(
            CommandApdu(
                ...
                p1 = 0x04,
                p2 = 0x00,
                payload = ByteString(applicationId),
                le = 0
            )
        )
     ...
     *
     * @param tWaitMillis Minimum waiting time as per NFC Forum Tag NDEF Exchange Protocol section 4.1.6.
    ...
    suspend fun ndefTransact(
        ...
        // Now read NDEF file...
        return ndefReadMessage(tWaitMillis, nWait)
    }
