...
class ASN1ObjectIdentifier(val oid: String): ASN1PrimitiveValue(tagNumber = TAG_NUMBER) {
    ...
    override fun encode(builder: ByteStringBuilder) {
        ...
        ASN1.appendUniversalTagEncodingLength(builder, TAG_NUMBER, encoding, componentsEncoded.size)
