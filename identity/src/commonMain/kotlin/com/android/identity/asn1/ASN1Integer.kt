...
class ASN1Integer(
    val value: ByteArray,
    tagNumber: Int = ASN1IntegerTag.INTEGER.tagNumber
): ASN1PrimitiveValue(tagNumber = tagNumber) {

    constructor(longValue: Long,
                tagNumber: Int = ASN1IntegerTag.INTEGER.tagNumber)
            : this(longValue.derEncodeToByteArray(), tagNumber)
    ...
    override fun equals(other: Any?): Boolean =
        other is ASN1Integer && tagNumber == other.tagNumber && value contentEquals other.value

    override fun hashCode(): Int = value.contentHashCode()

    override fun toString(): String {
        return "ASN1Integer($tagNumber, ${value.toHex()})"
    }
    ...
    companion object {
        fun parse(content: ByteArray, tagNumber: Int): ASN1Integer {
            return ASN1Integer(content, tagNumber)
        }
    }
}
