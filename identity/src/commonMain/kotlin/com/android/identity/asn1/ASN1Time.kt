...
class ASN1Time(
    ...
    override fun equals(other: Any?): Boolean =
        other is ASN1Time && other.tagNumber == tagNumber && other.value == value

    override fun hashCode(): Int = value.hashCode()

    override fun toString(): String {
        return "ASN1Time($tagNumber, $value)"
    }

    companion object {
        fun parse(content: ByteArray, tagNumber: Int): ASN1Time {
            val str = content.decodeToString()
            val parsedTime = when (tagNumber) {
                ASN1TimeTag.UTC_TIME.tagNumber -> {
            ...
            return ASN1Time(parsedTime, tagNumber)
        }
    }
}
