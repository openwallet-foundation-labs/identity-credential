...
class HolderExecutorTest {

    lateinit var interpreter: IDataInterpreter

    lateinit var transportLayer: ITransportLayer

    lateinit var sessionManager: HolderSessionManager

    lateinit var transportEventListener: ITransportEventListener
}