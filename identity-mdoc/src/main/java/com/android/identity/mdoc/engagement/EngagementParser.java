...
public class EngagementParser {
    ...
    @NonNull public Engagement parse() {
        EngagementParser.Engagement engagement = new Engagement();
    ...
    public static class Engagement {
        ...
        private EcCurve mESenderKeyCurve;
         ...
         */
        public EcCurve getESenderKeyCurve() {
        ...
        void parse(@NonNull byte[] encodedEngagement) {
            ...
            if (Util.cborMapHasKey(map, 2)) {
                ...
                for (DataItem cmDataItem : connectionMethodItems) {
                    ConnectionMethod connectionMethod = ConnectionMethod.fromDeviceEngagement(Util.cborEncode(cmDataItem));
