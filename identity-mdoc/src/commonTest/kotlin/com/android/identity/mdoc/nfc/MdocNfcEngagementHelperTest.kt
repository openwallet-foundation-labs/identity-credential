 ...
 * but it also exercise and verifies performNfcHandover() and other things on the reader side.
 */
class MdocNfcEngagementHelperTest {
    ...
    fun testStaticHandover() = runTest {
        ...
        val builder = MdocNfcEngagementHelper.Builder(
        ...
        builder.useStaticHandover(staticHandoverConnectionMethods)
        val engagementHelper = builder.build()
    ...
    fun testNegotiatedHandover() = runTest {
        ...
        builder.useNegotiatedHandover( { methods -> methods.first() } )
        val engagementHelper = builder.build()
    ...
    private fun testNfcEngagementHelper(
        ...
        val helper = MdocNfcEngagementHelper.Builder(
            ...
            .useStaticHandover(getConnectionMethods())
            .build()
    ...
    fun testBuilder() {
        assertFailsWith(
            ...
            MdocNfcEngagementHelper.Builder(
                Crypto.createEcPrivateKey(EcCurve.P256).publicKey,
                { connectionMethods, encodedDeviceEngagement, handover -> },
                { error -> }
            ).build()
        }
        ...
        assertFailsWith(
            ...
            MdocNfcEngagementHelper.Builder(
                ...
                .useNegotiatedHandover( { methods -> methods.first() } )
                .useStaticHandover(getConnectionMethods())
                .build()
        }
