 ...
 *
 * Applications can instantiate a [MdocNfcEngagementHelper] using [MdocNfcEngagementHelper.Builder]
 * and specify whether to use static or negotiated handover as well as other details. APDUs received
 * from the NFC tag reader should be passed to the [processApdu] method.
 */
class MdocNfcEngagementHelper private constructor(
    private val eDeviceKey: EcPublicKey,
    private val onHandoverComplete: (
    ...
    private var staticHandoverMethods: List<ConnectionMethod>? = null
    ...
    private var negotiatedHandoverPicker: ((connectionMethods: List<ConnectionMethod>) -> ConnectionMethod)? = null
    ...
    /**
     * A builder for [MdocNfcEngagementHelper].
     *
    ...
    class Builder(
        ...
        private val helper = MdocNfcEngagementHelper(
            eDeviceKey,
            onHandoverComplete,
            onError
        )
        ...
        /**
         * Use NFC static handover.
         *
         * @param staticHandoverMethods the list of connection methods to offer the mdoc reader, must contain at
         * least one element.
         * @return the builder.
         */
        fun useStaticHandover(staticHandoverMethods: List<ConnectionMethod>) = apply {
            check(!staticHandoverMethods.isEmpty()) { "Must have at least one ConnectionMethod for static handover" }
            helper.staticHandoverMethods = staticHandoverMethods
        }

        /**
         * Use NFC negotiated handover.
         *
         * @param chooseConnectionMethod a function to choose one of the connection methods from the mdoc reader.
         * @return the builder.
         */
        fun useNegotiatedHandover(
            chooseConnectionMethod: (connectionMethods: List<ConnectionMethod>) -> ConnectionMethod
        ) = apply {
            helper.negotiatedHandoverPicker = chooseConnectionMethod
        }

        /**
         * Builds the engagement helper.
         *
         * @return a [MdocNfcEngagementHelper].
         */
        fun build(): MdocNfcEngagementHelper {
            val static = helper.staticHandoverMethods != null
            val negotiated = helper.negotiatedHandoverPicker != null
