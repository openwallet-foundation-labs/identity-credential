...
public final class TerminalFactory {
    ...
    private final static String defaultType =null;

    private final static TerminalFactory defaultFactory = null;
/*
    static {
...
*/
        if(type.isEmpty() || type.compareTo(new String("CardTerminalSimulator")) !=0){
            throw new NoSuchAlgorithmException();
        }
        //return new TerminalFactory(new JCSFactory(), new JCardSimProvider(), type);
        return new TerminalFactory(mTermFactSpi, mProvider,type);
    }
    private static TerminalFactorySpi mTermFactSpi;
    private static Provider mProvider;
    public static void setProperties(TerminalFactorySpi factory, Provider prov){
        mTermFactSpi = factory;
        mProvider = prov;
    }
    /**
     * Returns a TerminalFactory of the specified type that is initialized
