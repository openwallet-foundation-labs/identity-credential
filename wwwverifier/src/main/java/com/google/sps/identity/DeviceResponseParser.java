...
public final class DeviceResponseParser {
    ...
    */
   public    DeviceResponseParser setDeviceResponse(   byte[] encodedDeviceResponse) {
    ...
    * @return the <code>DeviceResponseParser</code>.
    */
   public    DeviceResponseParser setSessionTranscript(
    ...
    * @return the <code>DeviceResponseParser</code>.
    */
   public    DeviceResponseParser setEphemeralReaderKey(   PrivateKey eReaderKey) {
   ...
   public static final class DeviceResponse {
       ...
       //
       private Map<PublicKey, Map<String, Map<Long, byte[]>>> parseMso(DataItem mso,
           ...
           Map<PublicKey, Map<String, Map<Long, byte[]>>> tempMap = new HashMap<>();
           tempMap.put(deviceKey, ret);
 
           //return Pair(deviceKey, ret);
           return tempMap;
       }
       ...
       PublicKey parseIssuerSigned(
           ...
           Map<PublicKey, Map<String, Map<Long, byte[]>>> msoResult =
                   parseMso(mobileSecurityObject, expectedDocType);
            
            Map.Entry<PublicKey, Map<String, Map<Long, byte[]>>> entry = msoResult.entrySet().iterator().next();
            final PublicKey deviceKey = entry.getKey();
            Map<String, Map<Long, byte[]>> digestMapping = entry.getValue();
            //for (Map.Entry<PublicKey, Map<String, Map<Long, byte[]>>> e : msoResult.entrySet()) {
            //    deviceKey = e.getKey();
            //    digestMapping = e.getValue();
            //}
   ...
   public static class Document {
        ...
        */
       public    List<String> getIssuerEntryNames(   String namespaceName) {
        ...
        */
       public boolean getIssuerEntryDigestMatch(   String namespaceName,
                  String name) {
           Map<String, EntryData> innerMap = mIssuerData.get(namespaceName);
           if (innerMap == null) {
               throw new IllegalArgumentException("Namespace not in data");
        ...
        * @exception IllegalArgumentException if the given namespace or entry isn't in the data.
        */
       public    byte[] getIssuerEntryData(   String namespaceName,
                  String name) {
           Map<String, EntryData> innerMap = mIssuerData.get(namespaceName);
           if (innerMap == null) {
               throw new IllegalArgumentException("Namespace not in data");
        ...
        */
       public    String getIssuerEntryString(   String namespaceName,
                  String name) {
        ...
        * @exception IllegalArgumentException if the CBOR data isn't in data or not the right type.
        */
       public    byte[] getIssuerEntryByteString(   String namespaceName,
                  String name) {
           byte[] value = getIssuerEntryData(namespaceName, name);
        ...
        * @exception IllegalArgumentException if the CBOR data isn't in data or not the right type.
        */
       public boolean getIssuerEntryBoolean(   String namespaceName,    String name) {
           byte[] value = getIssuerEntryData(namespaceName, name);
        ...
        * @exception IllegalArgumentException if the CBOR data isn't in data or not the right type.
        */
       public long getIssuerEntryNumber(   String namespaceName,    String name) {
           byte[] value = getIssuerEntryData(namespaceName, name);
        ...
        * @exception IllegalArgumentException if the CBOR data isn't in data or not the right type.
        */
       public    Timestamp getIssuerEntryDateTime(   String namespaceName,
                  String name) {
           byte[] value = getIssuerEntryData(namespaceName, name);
        ...
        * @exception IllegalArgumentException if the given namespace isn't in the data.
        */
       public    List<String> getDeviceEntryNames(   String namespaceName) {
        ...
        * @exception IllegalArgumentException if the given namespace or entry isn't in the data.
        */
       public    byte[] getDeviceEntryData(   String namespaceName,
                  String name) {
           Map<String, EntryData> innerMap = mDeviceData.get(namespaceName);
           if (innerMap == null) {
               throw new IllegalArgumentException("Namespace not in data");
        ...
        * @exception IllegalArgumentException if the CBOR data isn't in data or not the right type.
        */
       public    String getDeviceEntryString(   String namespaceName,
                  String name) {
        ...
        * @exception IllegalArgumentException if the CBOR data isn't in data or not the right type.
        */
       public    byte[] getDeviceEntryByteString(   String namespaceName,
                  String name) {
           byte[] value = getDeviceEntryData(namespaceName, name);
           return Util.cborDecodeByteString(value);
       }
        ...
        * @exception IllegalArgumentException if the CBOR data isn't in data or not the right type.
        */
       public boolean getDeviceEntryBoolean(   String namespaceName,
                  String name) {
           byte[] value = getDeviceEntryData(namespaceName, name);
           return Util.cborDecodeBoolean(value);
       }
        ...
        * @exception IllegalArgumentException if the CBOR data isn't in data or not the right type.
        */
       public long getDeviceEntryNumber(   String namespaceName,    String name) {
           byte[] value = getDeviceEntryData(namespaceName, name);
           return Util.cborDecodeLong(value);
       }
        ...
        * @exception IllegalArgumentException if the CBOR data isn't in data or not the right type.
        */
       public    Timestamp getDeviceEntryDateTime(   String namespaceName,
                  String name) {
           byte[] value = getDeviceEntryData(namespaceName, name);
           return Util.cborDecodeDateTime(value);
       }
       ...
       static class Builder {
           ...
           Builder setValidityInfoSigned(   Timestamp value) {
               mResult.mValidityInfoSigned = value;
               return this;
           }
 
           Builder setValidityInfoValidFrom(   Timestamp value) {
               mResult.mValidityInfoValidFrom = value;
               return this;
           }
 
           Builder setValidityInfoValidUntil(   Timestamp value) {
               mResult.mValidityInfoValidUntil = value;
               return this;
           }
 
           Builder setValidityInfoExpectedUpdate(   Timestamp value) {
               mResult.mValidityInfoExpectedUpdate = value;
               return this;
           }
 
           Builder setDeviceKey(   PublicKey deviceKey) {
