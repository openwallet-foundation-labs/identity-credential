 ...
 */
public final class SessionEncryptionDevice {
     ...
     */
    public SessionEncryptionDevice(PrivateKey eDeviceKeyPrivate,
     ...
     */
    public byte[] encryptMessageToReader(byte[] messagePlaintext, OptionalLong statusCode) {
