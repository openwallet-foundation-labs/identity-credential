...
public abstract class DataTransport {
    ...
    DataTransport(DataTransportOptions options) {
        //mContext = context;
        mOptions = options;
    }
    ...
    void sendMessage(byte[] data, TransmissionProgressListener progressListener, Executor progressListenerExecutor) {
    ...
    */
    ...
    protected void reportConnectionResult(Throwable error) {
        final Listener listener = mListener;
        final Executor executor = mListenerExecutor;
        if (!mInhibitCallbacks && listener != null && executor != null) {
    ...
    */
    ...
    interface Listener {
         ...
         */
        void onConnectionResult(Throwable error);
