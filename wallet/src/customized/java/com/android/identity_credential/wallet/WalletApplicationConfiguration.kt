...
object WalletApplicationConfiguration {
     ...
     * "dev:".
     */
    const val MIN_SERVER_DEFAULT_URL = "https://ws.utopia-central-registry.org/server"
     ...
     */
    const val CLOUD_SECURE_AREA_DEFAULT_URL = "https://ws.utopia-central-registry.org/server/csa"
}