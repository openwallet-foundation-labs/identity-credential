...
/**
 * An enumeration of Credential Presentation Formats.
 */
enum class CredentialPresentationFormat {

    /**
     * This Credential Presentation Format is for mdoc as defined in
     * [ISO/IEC 18013-5:2021](https://www.iso.org/standard/69084.html).
     *
     * For this presentation format, the [CredentialPresentationObject.presentationData]
