...
import com.android.identity.android.mdoc.transport.DataTransportHttp;
...
public class DataTransportHttpTest {
    ...
    public void uriParsing() {
        ...
        DataTransportHttp transport = (DataTransportHttp) DataTransport.fromConnectionMethod(
                appContext, cm , DataTransport.ROLE_MDOC, options);
        ...
        transport = (DataTransportHttp) DataTransport.fromConnectionMethod(
                appContext, cm, DataTransport.ROLE_MDOC, options);
