...
class NdefService: HostApduService() {
    ...
    private fun startEngagement() {
        ...
        //builder.useStaticHandover(staticHandoverMethods)
        builder.useNegotiatedHandover(chooseConnectionMethod = { connectionMethods -> connectionMethods.first() })
        engagement = builder.build()
    }
