...
private fun ShowReaderResults(
    ...
    if (deviceResponse1 == null || deviceResponse1.isEmpty()) {
        ...
        Logger.i("CORY", "${readerSessionTranscript.value!!.toHex()}")
...
private data class DocumentData(
    ...
    companion object {
        ...
        fun fromZkMdocDeviceResponseDocument(
            ...
            try {
                val zkSystemSpec = zkSystemRepository.findZkSystemSpecByGeneratedId(zkDocument.zkDocumentData.zkSystemSpecId)
