...
class App private constructor (val promptModel: PromptModel) {
    ...
    private suspend fun settingsInit() {
        settingsModel = TestAppSettingsModel.create(Platform.getStorage())
    }
    ...
    private suspend fun documentStoreInit() {
        softwareSecureArea = SoftwareSecureArea.create(Platform.getStorage())
    ...
    private suspend fun keyStorageInit() {
        keyStorage = Platform.getStorage().getTable(
            StorageTableSpec(
                name = "TestAppKeys",
