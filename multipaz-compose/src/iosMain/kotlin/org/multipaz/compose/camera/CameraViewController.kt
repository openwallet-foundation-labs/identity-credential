...
class CameraViewController(
    ...
    private fun setupCamera() {
        ...
        if (captureSession.canAddInput(videoInput)) {
            ...
            println("Failed to add input to the capture session.")
        }
        ...
        println("Capture session config committed.")
    }

    private fun setupPreviewView() {
        println("setupPreviewView!")
    ...
    private fun getVideoOrientationForDevice(): AVCaptureVideoOrientation {
        return when (UIDevice.currentDevice.orientation) {
            ...
            UIDeviceOrientation.UIDeviceOrientationFaceUp -> doNotChange
            UIDeviceOrientation.UIDeviceOrientationFaceDown -> doNotChange
            else -> AVCaptureVideoOrientationPortrait // Default to portrait.
        }
    }
}