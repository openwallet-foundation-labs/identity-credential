...
class DSCertificateTests {
    ...
    private val certificateBytes1 = byteArrayOf(
        ...
        0xc7.toByte(), 0x79.toByte(), 0xda.toByte(), 0x9d.toByte(), 0x30.toByte(),
        ...
        0x30.toByte(), 0x38.toByte(), 0x32.toByte(), 0x31.toByte(), 0x31.toByte(),
        0x36.toByte(), 0x31.toByte(), 0x30.toByte(), 0x33.toByte(), 0x31.toByte(),
        0x5a.toByte(), 0x17.toByte(), 0x0d.toByte(), 0x32.toByte(), 0x31.toByte(),
        0x31.toByte(), 0x31.toByte(), 0x31.toByte(), 0x39.toByte(), 0x31.toByte(),
        0x36.toByte(), 0x31.toByte(), 0x30.toByte(), 0x33.toByte(), 0x31.toByte(),
        ...
        0x45.toByte(), 0x02.toByte(), 0x20.toByte(), 0x4a.toByte(), 0x00.toByte(),
        0x26.toByte(), 0x31.toByte(), 0x69.toByte(), 0xab.toByte(), 0x6d.toByte(),
        0xef.toByte(), 0x0e.toByte(), 0x4f.toByte(), 0xa4.toByte(), 0x22.toByte(),
        0x26.toByte(), 0xaa.toByte(), 0x7f.toByte(), 0xc7.toByte(), 0x37.toByte(),
        0x55.toByte(), 0xe9.toByte(), 0x43.toByte(), 0xd1.toByte(), 0xba.toByte(),
        0x4e.toByte(), 0x2c.toByte(), 0x87.toByte(), 0xfa.toByte(), 0x5c.toByte(),
        0xf3.toByte(), 0xd9.toByte(), 0x42.toByte(), 0x1e.toByte(), 0x3e.toByte(),
        0x02.toByte(), 0x21.toByte(), 0x00.toByte(), 0xaf.toByte(), 0x09.toByte(),
        0xd8.toByte(), 0x45.toByte(), 0x1c.toByte(), 0xdc.toByte(), 0x7d.toByte(),
        0x41.toByte(), 0x96.toByte(), 0x7e.toByte(), 0x56.toByte(), 0x11.toByte(),
        0xba.toByte(), 0x46.toByte(), 0x4d.toByte(), 0x0f.toByte(), 0xf6.toByte(),
        0xbb.toByte(), 0x1d.toByte(), 0xd0.toByte(), 0x17.toByte(), 0x9c.toByte(),
        0x4a.toByte(), 0x5d.toByte(), 0x01.toByte(), 0xca.toByte(), 0xbb.toByte(),
        0x27.toByte(), 0xda.toByte(), 0x33.toByte(), 0x87.toByte(), 0x39.toByte()
    )
