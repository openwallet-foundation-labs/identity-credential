...
open class CloudSecureArea(
     ...
     *
     * @param passphrase the wallet passphrase or `null`.
     * @param passphraseConstraints the constraints for the wall passphrase.
    ...
    suspend fun register(
        ...
        try {
            ...
            // We need E2EE before setting the passphrase
            setupE2EE(false)

            // Setting the passphrase modifies the registrationContext...
            val spRequest0 = CloudSecureAreaProtocol.SetPassphraseRequest0(passphrase)
            val spResponse0 = CloudSecureAreaProtocol.Command.fromCbor(communicateE2EE(spRequest0.toCbor()))
                    as CloudSecureAreaProtocol.SetPassphraseResponse0
            registrationContext = spResponse0.serverState
            storageEngine.put("${identifier}_registrationContext", registrationContext!!)
    ...
    override fun sign(
        ...
        try {
            ...
            val passphrase = (keyUnlockData as CloudKeyUnlockData?)?.passphrase ?: ""
