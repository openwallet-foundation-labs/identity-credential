...
class CloudSecureAreaTest {
    ...
    fun testPassphraseCannotBeChanged() = runTest {
        ...
        // attacker could conceivable just try to send the low-level commands themselves.
        //
        // Check that this doesn't work.
        //
        try {
            val spRequest0 = CloudSecureAreaProtocol.SetPassphraseRequest0("New Passphrase")
